...
export default function Home() {
  ...
  return (
    <div className="dark:bg-gray-900 min-h-[80vh]">
      ...
      <section className="flex flex-col md:flex-row items-center px-8 py-20">
        ...
        <div className="flex-1 space-y-5">
          ...
          <p className="text-gray-600 text-lg md:w-3/4">
            Stay organized, boost productivity, and complete tasks with ease.
           <TMS/> helps you manage everything in one place.
          </p>
      ...
      {/* Features Section */}
      <section id="features" className="px-8 dark:bg-gray-900 py-20 bg-white">
      ...
      {/* CTA Section */}
      <section className="px-8 py-16 dark:bg-gray-900 dark:text-white text-center">
        <h2 className="text-4xl font-bold">
         Boost Your Productivity
        </h2>
        <p className="mt-3 text-lg">
          Use <TMS/> today and take control of your tasks like never before!
        </p>
...
function FeatureCard({
  ...
  return (
    <div className="dark:bg-gray-600 bg-yellow-100 shadow rounded-xl p-6">
